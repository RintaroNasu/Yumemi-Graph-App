...
export const PrefecturesCheckList = () => {
    ...
    const fetchPopulationData = async () => {
      ...
      try {
        for (const prefCode of selectedPrefectures) {
          ...
          population.result.data[0].data.forEach((item: { year: number; value: number }, index: number) => {
  ...
  return (
    <>
      ...
      <div className="mt-5">
        <div className="w-full text-center text-2xl font-semibold mb-4">総人口推移</div>
